...
var bookTitle3 = "The Hobbit";
var bookAuthor3 = "J. R. R. Tolkien";
console.log(bookTitle3 + " by " + bookAuthor3);

var bookTitle4 = "The Hobbit";
var bookAuthor4 = "J. R. R. Tolkien";
console.log(bookTitle4 + " by " + bookAuthor4);

var bookTitle5 = "The Hobbit";
var bookAuthor5 = "J. R. R. Tolkien";
console.log(bookTitle5 + " by " + bookAuthor5);

var bookTitle6 = "The Hobbit";
var bookAuthor6 = "J. R. R. Tolkien";
console.log(bookTitle6 + " by " + bookAuthor6);

var bookTitle7 = "The Hobbit";
var bookAuthor7 = "J. R. R. Tolkien";
console.log(bookTitle7 + " by " + bookAuthor7);
