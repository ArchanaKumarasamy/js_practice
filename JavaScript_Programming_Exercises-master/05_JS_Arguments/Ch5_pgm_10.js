...
showPlayerHealth = function (playerName, playerHealth,healthMultiplier) {
    console.log(playerName + " has health " + playerHealth+ " * " +healthMultiplier);
};
...
showPlayerHealth(player1.name, player1.health,healthMultiplier);
showPlayerHealth(player2.name, player2.health,healthMultiplier);
